...
export default function ParentDashboard() {
  const [selectedChild, setSelectedChild] = useState('Alex'); // Mock selected child
  ...
  return (
      <div className={`min-h-screen p-6 bg-white/80 dark:bg-gray-900/80 text-gray-900 dark:text-white`}>
